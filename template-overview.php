            ...
            <article id="post-<?php the_ID();?>" <?php post_class('game-post container');?>>
                ...
                <div class="row">
                    ...
                    <div class="post__content col-md-8">
                        ...
                        <div>
                            <?php if (get_field('question_count')): ?>
                            <strong>Aantal Vragen:</strong> <span> <?php the_field('question_count') ?> </span>
                            <?php endif; ?>
                        </div>
                        ...
                        <a href="<?php the_field('game_link') ?>" class="btn btn-primary">Zet toets klaar</a>
                    </div>
                    </div>
