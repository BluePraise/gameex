...
(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        _attachEvents: function(field, nr) {
            ...
            field.on(
                ...
                $.proxy(function(e) {
                    if (
                        !$(this).is("[readonly]") &&
                        that._values[nr] != undefined &&
                        that.settings.hideinput
                    )
            ...
            field.on(
                ...
                $.proxy(function(e) {
                    ...
                    // when user goes back
                    if ((e.keyCode == 37 || e.keyCode == 8) && nr > 0) {
        ...
        _reset: function() {
            ...
            if (this.settings.autofocus) this._focus(0);
        },
...
(function($, root, undefined) {
    $(function() {
        ...
        $(".js-collapse-story").click(function() {
            ...
            $(this).toggleClass("collapse__top--closed");
        });

        $(".js-show-search").click(function() {
            $(".search-popup").addClass("search-popup--show");
        });
